...
<table WIDTH="100%" border="4">
    <caption>Seguimiento Academico Docente</caption>
    <tr>
      <td>Nombre {{$nombreDocente}}</td>
      <td>C.I.</td>
      </tr>
 </table>
 ...
 <table border="1" WIDTH="100%">
    ...
    <tr>
      <th scope="col" id="horas">Horas</th>
        <th scope="colgroup" colspan="5">Lunes</th>
        <th scope="colgroup" colspan="5">Martes</th>
        <th scope="colgroup" colspan="5">Miercoles</th>
        <th scope="colgroup" colspan="5">Jueves</th>
        <th scope="colgroup" colspan="5">Viernes</th>
        <th scope="colgroup" colspan="5">Sabado</th>
    </tr>
